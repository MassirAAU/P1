...
\usepackage{amsmath}
\usepackage{pifont}
\usepackage[danish]{babel} % language support - hyphenations etc.
...
\FXRegisterAuthor{ma}{ama}{Massir}
\FXRegisterAuthor{bj}{abj}{Bjørn}
\FXRegisterAuthor{fa}{afa}{Fatimah}
\FXRegisterAuthor{mo}{amo}{Morten}
\FXRegisterAuthor{ra}{ara}{Rasmus}
\FXRegisterAuthor{ro}{aro}{Rong}
